...
import { getAdminCourse, updateAdminCourse } from "@/courses/service";
import { updateAdminCourseSchema } from "@/courses/validation";
...
export async function GET(request: NextRequest, context: RouteContext) {
  try {
    ...
    const course = await getAdminCourse(authorization.db, id);
...
export async function PATCH(request: NextRequest, context: RouteContext) {
  ...
  try {
    ...
    const parsed = updateAdminCourseSchema.safeParse(body);
